...
{
	if ((((box->all_map[(int)y][(int)(x + d_x * box->go.spd + 0.15)] == 8) ||
		(box->all_map[(int)y][(int)(x + d_x * box->go.spd - 0.15)] == 8)) ||
		((box->all_map[(int)(y + d_y * box->go.spd + 0.15)][(int)x] == 8) ||
		(box->all_map[(int)(y + d_y * box->go.spd - 0.15)][(int)x] == 8))) &&
		(box->keys[SDL_SCANCODE_E] == 1))
	{
		box->all_map[(int)y][(int)(x + d_x * box->go.spd + 0.15)] = 1;
		box->all_map[(int)y][(int)(x + d_x * box->go.spd - 0.15)] = 1;
		box->all_map[(int)(y + d_y * box->go.spd + 0.15)][(int)x] = 1;
		box->all_map[(int)(y + d_y * box->go.spd - 0.15)][(int)x] = 1;
	}
	else if ((((box->all_map[(int)y][(int)(x + d_x * box->go.spd + 0.15)] == 1) ||
		(box->all_map[(int)y][(int)(x + d_x * box->go.spd - 0.15)] == 1)) ||
		((box->all_map[(int)(y + d_y * box->go.spd + 0.15)][(int)x] == 1) ||
		(box->all_map[(int)(y + d_y * box->go.spd - 0.15)][(int)x] == 1))) &&
		(box->keys[SDL_SCANCODE_E] == 1))
